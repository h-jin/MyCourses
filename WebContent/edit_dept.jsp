...
<div class="container">
	<div class="row row-offcanvas row-offcanvas-right">
		<div class="col-xs-12 col-sm-9">
			...
			<form role="form" method="post" name="deptForm" action="DepartmentController?action=update_dept&id=<c:out value="${dept.id}"/>" onsubmit="return validateForm()">	
			
				  <div class="form-group">
					  
					    <input type="text" maxlength="45" class="form-control" name="deptname" placeholder="<c:out value="${dept.deptname}"/>">
					  </div>
					  <div class="form-group">
					    
					    <input type="text" maxlength="255" class="form-control" name="contact" placeholder="<c:out value="${dept.contact}"/>">
					  </div>
