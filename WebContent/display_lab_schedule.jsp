	...
	<div class="row row-offcanvas row-offcanvas-right">
		<div class="col-xs-12 col-sm-9">
			<div class="jumbotron">
					...
					<tbody>
						<c:forEach items="${schedules}" var="ss">
					   		<tr>
								...
								<td > <a type="button" class="btn btn-primary btn-xs" href="ScheduleController?action=delete_lab&id=<c:out value="${ss.id}"/> " onclick="javascript:return myFunction()">delete</a></td>				
							</tr>	
				...
				<a type="button" class="btn btn-primary btn-xs" href="ScheduleController?action=add_lab">add</a></td>
		</div>
	</div>
